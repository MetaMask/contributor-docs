...
Engineering principles define the core tenents and beliefs that the engineering team and all contributors are expected to keep front of mind. These tenents are meant to reflect the values of the organization as well as the philosophy upon which the software was founded. Principles typically come in the form of punchy one line statements, but a great deal of depth can be written on each one to further inform of the intent of the statement.
